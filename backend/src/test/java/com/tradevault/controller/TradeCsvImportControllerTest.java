...
class TradeCsvImportControllerTest {
    ...
    void importCsvCreatesTradeForAuthenticatedUser() throws Exception {
        ...
        String csv = String.join("\n",
                ...
                "Market buy,2024-01-01 10:00:00,US123,ACME,Acme Corp,tx1,10,100,USD,1,,USD,1000,USD",
                "Market sell,2024-01-02 10:00:00,US123,ACME,Acme Corp,tx2,10,110,USD,1,100,USD,1100,USD"
        );
