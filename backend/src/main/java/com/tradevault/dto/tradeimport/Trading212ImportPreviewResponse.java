...
public record Trading212ImportPreviewResponse(
        UUID importBatchId,
        ...
        List<UnsupportedRow> unsupportedRows,
    ...
    public record UnmappedSymbol(String externalSymbol, String suggestedInternalSymbol,
                                 String externalInstrument, String instrumentCurrency, Market suggestedMarket) {
    }
    ...
    public record TradePreview(
            ...
            BigDecimal initialTakeProfitPrice, BigDecimal finalStopLossPrice, BigDecimal finalTakeProfitPrice,
            BigDecimal grossPnl, BigDecimal commission, BigDecimal otherCosts, BigDecimal netPnl,
            String accountCurrency, String instrumentCurrency, BigDecimal sourceExchangeRate,
            BigDecimal reportedSpread, BigDecimal fxFee, BigDecimal resultAfterFxFee,
            BigDecimal overnightInterest, BigDecimal dividendAdjustment, BigDecimal priceDerivedPnl,
            BigDecimal pnlReconciliationDifference, String recordType, boolean duplicate, UUID existingTradeId,
            List<ManualMatch> potentialManualMatches, List<String> warnings, Map<String, String> rawSource
    ) {
    }
}
