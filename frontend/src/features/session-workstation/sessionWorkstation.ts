...
export function ensureTicket(ticket: ExecutionTicket | Partial<ExecutionTicket> | undefined, index: number): ExecutionTicket {
  ...
  return {
    ...
    contractMultiplier: ticket?.contractMultiplier ?? null,
    contractMetadataSource: ticket?.contractMetadataSource || null,
    tradeCurrency: ticket?.tradeCurrency || null,
    profileCurrency: ticket?.profileCurrency || null,
    fxRateTradeToProfile: ticket?.fxRateTradeToProfile ?? null,
    fxRateSource: ticket?.fxRateSource || null,
    plannedRr: ticket?.plannedRr ?? null,
    estimatedPriceRisk: ticket?.estimatedPriceRisk ?? null,
    costsIncluded: ticket?.costsIncluded ?? false,
    calculationStatus: ticket?.calculationStatus || null,
    unavailableReasons: ticket?.unavailableReasons || [],
...
export function toSetupPayload(setup: SetupItem): SetupDraftRequest {
  ...
  return {
    accountRefId: normalized.accountRefId || null,
    sourceDraftId: normalized.sourceDraftId || null,
