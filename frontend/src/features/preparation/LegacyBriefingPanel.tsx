...
export function LegacyBriefingPanel({ date, preparation: p, onVersion, coach = false }: { date: string; preparation: Preparation; onVersion: (id: string) => void; coach?: boolean }) {
  const { t } = useI18n()
