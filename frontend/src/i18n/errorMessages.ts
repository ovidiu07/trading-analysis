...
const API_CODE_MAP: Record<string, string> = {
  ...
  BACKTEST_PROVIDER_NOT_CONNECTED: 'errors.BACKTEST_PROVIDER_NOT_CONNECTED',
  BACKTEST_PROVIDER_NOT_CONFIGURED: 'errors.BACKTEST_PROVIDER_NOT_CONFIGURED',
  CSV_PARSE_ERROR: 'errors.CSV_PARSE_ERROR',
  CSV_MAPPING_REQUIRED: 'errors.CSV_MAPPING_REQUIRED',
  DATASET_NOT_FOUND: 'errors.DATASET_NOT_FOUND',
  INVALID_ACCOUNT_SELECTION: 'errors.INVALID_ACCOUNT_SELECTION',
  UNSUPPORTED_SYMBOL_TIMEFRAME: 'errors.UNSUPPORTED_SYMBOL_TIMEFRAME',
