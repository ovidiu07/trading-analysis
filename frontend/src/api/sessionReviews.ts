...
export type Preparation = {
  briefingId?: string; step: number; briefingSession: 'ASIA' | 'LONDON'; manualSession: boolean;
...
export type SessionReview = {
  ...
  readyContext?: { readyAt: string; revision: number; focus: string; instruments: string; preparation: Preparation; briefing?: { asOf: string; id: string }; strategyContext?: SessionReview['strategyContext'] };
